...
wb = load_workbook('kano_pocr_v1.xlsx')
...
ocr = PaddleOCR(use_gpu=False, lang="ch", type="structure", det_db_box_thresh=0.05, det_db_thresh=0.05, det_db_unclip_ratio=1.0, max_batch_size=10, use_mp=True)
...
for i in list(df_empty['image_url']):
    img_path = i
    index = empty_list[a]
    output = open('/home/ec2-user/SageMaker/OCR/paddleocr/outputs/MedReport/kano_raw_hair_a3.txt', 'a+')
